...
After several iterations, the selected review sentiment model is based on 
sentence-level polarity, and the final review stars prediction model formula 
...
Next, the polarity-analyzed restaurant review datasets were partitioned (70% for training 
and 30% for testing); and the prediction model were fitted on the training dataset 
using the three methods with 3-fold cross-validation.  Finally, the fitted models
were evaluated for accuracy on the unseen testing dataset.
...
this paper can be found at : [DSS_Capstone.Rmd - Kuan (2015)](https://github.com/kuansw/DSS_Capstone/blob/master/DSS_Capstone.Rmd).
